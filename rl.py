...
parser.add_argument(
    "-A",
    "--agent_type",
    default="SARSATabular",
    type=str,
    choices=AGENT_TYPES,
    help="""A Reinforcement Learning Agent.""",
)
...
parser.add_argument(
    "-s", "--size", default=3, type=int, help="""The side of the visible square grid."""
)
